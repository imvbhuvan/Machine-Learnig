...
import os
os.chdir('D:\ML\ML-codes')


data_income = pd.read_csv(r'income.csv')                                         
...
"""
data = pd.read_csv(r'income.csv',na_values=[" ?"]) 
...
############# Box Plot - hours/week vs Salary status #################
...
f1_scr = sklearn.metrics.f1_score(test_y,prediction,  labels=None, pos_label=1, average='binary', sample_weight=None, zero_division='warn')
